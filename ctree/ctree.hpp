...
template <class PointTraits_, class Distance_, index_type Index_>
void GhostTree<PointTraits_, Distance_, Index_>::point_query(const Point& query, Real epsilon, IndexVector& neighbors) const
{
...
template <class PointTraits_, class Distance_, index_type Index_>
void GhostTree<PointTraits_, Distance_, Index_>::ghost_point_query(const Point& query, Real epsilon, IndexVector& neighbors) const
{
...
template <class PointTraits_, class Distance_, index_type Index_>
void GhostTree<PointTraits_, Distance_, Index_>::reptree_point_query(const Point& query, Real epsilon, IndexVector& neighbors) const
{
...
template <class PointTraits_, class Distance_, index_type Index_>
void GhostTree<PointTraits_, Distance_, Index_>::hub_query(const Point& query, Real ghost_radius, IndexVector& hub_ids) const
{
    IndexVector stack = {0};
...
template <class PointTraits_, class Distance_, index_type Index_>
void GhostTree<PointTraits_, Distance_, Index_>::write_tree_file(const char *fname) const
{
...
template <class PointTraits_, class Distance_, index_type Index_>
bool GhostTree<PointTraits_, Distance_, Index_>::is_correct(Real split_ratio) const
{
    const Index n = tree.num_vertices();
